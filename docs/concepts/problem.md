...
- **Condition `x`** — a fixed `[C, H, W]` crop of GEO imagery from GOES ABI or Himawari AHI, optionally concatenated with ERA5 fields.
...
Storm geometry
: Manifests carry IBTrACS center coordinates and raster bounds. Metrics can therefore measure the eye, inner core, radial profile, and radius of maximum wind.
