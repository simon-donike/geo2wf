...
from geo2wf.models.residual_diffusion import (
    ERA5ResidualDiffusion,
    load_frozen_deterministic_baseline,
)
from geo2wf.models.conditional_diffusion import PixelDiffusionConditional
...
def load_config(config_path: str) -> dict:
    """Load a legacy YAML file or compose a Hydra defaults file."""
...
def build_model(config: dict) -> pl.LightningModule:
    ...
    if "_target_" in config.get("model", {}):
