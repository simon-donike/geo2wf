...
class WindFieldBatch(TypedDict):
    ...
    ibtracs_eye_size_km: NotRequired[torch.Tensor]
    ibtracs_eye_size_km_valid: NotRequired[torch.Tensor]
    ibtracs_rmw_km: NotRequired[torch.Tensor]
    ibtracs_rmw_km_valid: NotRequired[torch.Tensor]
    ibtracs_r34_equivalent_km: NotRequired[torch.Tensor]
    ibtracs_r34_equivalent_km_valid: NotRequired[torch.Tensor]
    ibtracs_r50_equivalent_km: NotRequired[torch.Tensor]
    ibtracs_r50_equivalent_km_valid: NotRequired[torch.Tensor]
    ibtracs_r64_equivalent_km: NotRequired[torch.Tensor]
    ibtracs_r64_equivalent_km_valid: NotRequired[torch.Tensor]
