...
class WindFieldBatch(TypedDict):
    ...
    ibtracs_r34_mean_km: NotRequired[torch.Tensor]
    ibtracs_r34_mean_km_valid: NotRequired[torch.Tensor]
    ibtracs_r50_mean_km: NotRequired[torch.Tensor]
    ibtracs_r50_mean_km_valid: NotRequired[torch.Tensor]
    ibtracs_r64_mean_km: NotRequired[torch.Tensor]
    ibtracs_r64_mean_km_valid: NotRequired[torch.Tensor]
